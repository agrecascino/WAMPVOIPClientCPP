...
# Template: app
# Command: /usr/lib64/qt5/bin/qmake -o Makefile WAMPVOIPClientCPP.pro
#############################################################################
...
CXXFLAGS      = -pipe -std=c++14 -O2 -Wall -W -fPIC $(DEFINES)
...
DISTDIR = /home/anthony/WAMPVOIPClientCPP/.tmp/WAMPVOIPClientCPP1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
Makefile: WAMPVOIPClientCPP.pro /usr/lib64/qt5/mkspecs/linux-g++/qmake.conf /usr/lib64/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib64/qt5/mkspecs/common/unix.conf \
		/usr/lib64/qt5/mkspecs/common/linux.conf \
		/usr/lib64/qt5/mkspecs/common/sanitize.conf \
		/usr/lib64/qt5/mkspecs/common/gcc-base.conf \
